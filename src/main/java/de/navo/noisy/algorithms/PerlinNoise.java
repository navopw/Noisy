...
public class PerlinNoise extends Noise {
	...
	public PerlinNoise frequency(int frequency) {
	...
	static public double noise(double x, double y, double z, Interpolation interpolation) {
		...
		return interpolation.interpolate(w,
				interpolation.interpolate(v,
						interpolation.interpolate(u,
